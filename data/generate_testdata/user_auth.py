# Generate auth records with user_id from 1 to 100000 and password as '123'
auth_records = []
for user_id in range(1, 100001):  # Assuming user_id ranges from 1 to 100000
    password = "123"
...
with open("insert_auth.sql", "w", encoding="utf-8") as file:
...
print("SQL insert script has been generated and saved to insert_auth.sql")
